package com.maachang.httpPush.util.sequence;
...
public class Time16SequenceId {
	...
	private static final String createId(int machineId, long time, int seqId) {
		return new StringBuilder().append(
				zero2((int) ((time & 0xff00000000000000L) >> 56L))).append(
				zero2((int) ((time & 0x00ff000000000000L) >> 48L))).append(
				zero2((int) ((time & 0x0000ff0000000000L) >> 40L))).append(
				zero2((int) ((time & 0x000000ff00000000L) >> 32L))).append("-")
				.append(zero2((int) ((time & 0x00000000ff000000L) >> 24L)))
				.append(zero2((int) ((time & 0x0000000000ff0000L) >> 16L)))
				.append("-").append(
						zero2((int) ((time & 0x000000000000ff00L) >> 8L)))
				.append(zero2((int) ((time & 0x00000000000000ffL) >> 0L)))
				.append("-").append(zero2((int) ((seqId & 0xff000000) >> 24)))
				.append(zero2((int) ((seqId & 0x00ff0000) >> 16))).append("-")
				.append(zero2((int) ((seqId & 0x0000ff00) >> 8))).append(
						zero2((int) ((seqId & 0x000000ff) >> 0))).append(
						zero2((int) ((machineId & 0xff000000) >> 24))).append(
						zero2((int) ((machineId & 0x00ff0000) >> 16))).append(
						zero2((int) ((machineId & 0x0000ff00) >> 8))).append(
						zero2((int) ((machineId & 0x000000ff) >> 0)))
				.toString();
	}
