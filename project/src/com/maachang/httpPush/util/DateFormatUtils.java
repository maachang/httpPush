...
/**
 * 日付フォーマット処理系ユーティリティ. 3種類の日付フォーマット変換に対応. 1)20130301 -> java.sql.Date(
 * 2013-1900,3-1,1 ) 連続した数値文字列のフォーマットを解析.
 * 
...
public final class DateFormatUtils {
    ...
    private static final java.util.Date cutDate(int type, String value) {
        ...
        if (type == 0) {
            ...
            case 2:
                return new java.sql.Date(getYear(list.get(0)),
                        Utils.parseInt(list.get(1)) - 1, 1);
            default:
                return new java.sql.Date(getYear(list.get(0)),
                        Utils.parseInt(list.get(1)) - 1, Utils.parseInt(list
                                .get(2)));
            }
        }
        // java.sql.Time.
            ...
            case 0:
                Date d = new java.util.Date();
                return new java.sql.Time(d.getHours(), d.getMinutes(),
                        d.getSeconds());
            case 1:
                return new java.sql.Time(Utils.parseInt(list.get(0)), 0, 0);
            case 2:
                return new java.sql.Time(Utils.parseInt(list.get(0)),
                        Utils.parseInt(list.get(1)), 0);
            default:
                return new java.sql.Time(Utils.parseInt(list.get(0)),
                        Utils.parseInt(list.get(1)),
        ...
        // java.sql.Timestamp.
            ...
            case 1:
                return new java.sql.Timestamp(getYear(list.get(0)), 0, 1, 0, 0,
                        0, 0);
            case 2:
                return new java.sql.Timestamp(getYear(list.get(0)),
                        Utils.parseInt(list.get(1)) - 1, 1, 0, 0, 0, 0);
            case 3:
                return new java.sql.Timestamp(getYear(list.get(0)),
                        Utils.parseInt(list.get(1)) - 1, Utils.parseInt(list
                                .get(2)), 0, 0, 0, 0);
            case 4:
                return new java.sql.Timestamp(getYear(list.get(0)),
                        Utils.parseInt(list.get(1)) - 1, Utils.parseInt(list
                                .get(2)), Utils.parseInt(list.get(3)), 0, 0, 0);
            case 5:
                return new java.sql.Timestamp(getYear(list.get(0)),
                        Utils.parseInt(list.get(1)) - 1, Utils.parseInt(list
                                .get(2)), Utils.parseInt(list.get(3)),
                        Utils.parseInt(list.get(4)), 0, 0);
            case 6:
                return new java.sql.Timestamp(getYear(list.get(0)),
                        Utils.parseInt(list.get(1)) - 1, Utils.parseInt(list
                                .get(2)), Utils.parseInt(list.get(3)),
                        Utils.parseInt(list.get(4)),
    ...
    private static final java.util.Date stringDate(int type, String value) {
        ...
        if (type == 0) {
            if (len < 4) {
                if (len == 0) {
                    Date d = new java.util.Date();
                    return new java.sql.Date(d.getYear(), d.getMonth(),
                            d.getDate());
                } else {
            ...
            if (len < 6) {
                ...
                return new java.sql.Date(getYear(value.substring(0, 4)),
                        Utils.parseInt(value.substring(4, 6)) - 1, 1);
            } else {
                return new java.sql.Date(getYear(value.substring(0, 4)),
                        Utils.parseInt(value.substring(4, 6)) - 1,
        ...
        // java.sql.Time.
            ...
            if (len < 4) {
                ...
                return new java.sql.Time(Utils.parseInt(value.substring(0, 2)),
                        Utils.parseInt(value.substring(2, 4)),
        ...
        // java.sql.Timestamp.
            ...
            if (len < 6) {
                ...
                return new java.sql.Timestamp(getYear(value.substring(0, 4)),
                        Utils.parseInt(value.substring(4, 6)) - 1,
                        Utils.parseInt(value.substring(6, 8)),
                        Utils.parseInt(value.substring(8, 10)), 0, 0, 0);
            } else if (len < 14) {
                return new java.sql.Timestamp(getYear(value.substring(0, 4)),
                        Utils.parseInt(value.substring(4, 6)) - 1,
                        Utils.parseInt(value.substring(6, 8)),
                        Utils.parseInt(value.substring(8, 10)),
                        Utils.parseInt(value.substring(10, 12)), 0, 0);
            } else if (len < 17) {
                if (len == 14) {
                    return new java.sql.Timestamp(
                            getYear(value.substring(0, 4)),
                            Utils.parseInt(value.substring(4, 6)) - 1,
                            Utils.parseInt(value.substring(6, 8)),
                            Utils.parseInt(value.substring(8, 10)),
                            Utils.parseInt(value.substring(10, 12)),
                    ...
                    return new java.sql.Timestamp(
                            ...
                            Utils.parseInt(value.substring(8, 10)),
                            Utils.parseInt(value.substring(10, 12)),
                            Utils.parseInt(value.substring(12, 14)),
